...
`ethogram_demo` is a small deterministic dataset designed to make plots easy to
reason about. Each subject has two trials with short, repeated behaviour runs.
